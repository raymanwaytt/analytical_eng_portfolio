...
//     if (!formData.name || !formData.email || !formData.budget || !formData.projectType || !formData.message) {
...
//         I'm currently available for freelance data analytics projects and consulting opportunities. Let's discuss how I can help transform your data into actionable insights.
//       </p>
//       <div className="mx-2">
